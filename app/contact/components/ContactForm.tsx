    ...
    >
      ...
      {sendSuccess && (
        <div className="flex flex-col justify-center items-center gap-4 w-full h-[26em] md:max-w-[35em] rounded-xl relative">
          <div className="absolute w-full h-full bg-site-green-light opacity-10 rounded-xl" />
          <div className="flex flex-col items-center text-site-green-light p-4 z-10 text-center">
            <p className="font-bold flex flex-col md:flex-row items-center md:items-baseline gap-2">
              <span className="bg-site-green-light min-w-7 min-h-7 rounded-full text-white flex items-center justify-center">
